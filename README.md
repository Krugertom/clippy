...
hit **⌘1** and a glass bar slides up from the bottom of your screen with everything you've copied — text, links, images, files. click a card to grab it again. that's pretty much it.
...
built with SwiftUI + Liquid Glass on macOS 26.
